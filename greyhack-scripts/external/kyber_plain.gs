// kyber_plain.gs - Pure Kyber implementation (no helpers, for reference)
...
// Kyber public API (no extra helpers, just the core three functions)
...
// No return statement – this file is for reference only.
// To use, import /external/kyber_plain.gs and use Kyber.keygen, etc.